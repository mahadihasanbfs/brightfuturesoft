                                                ...
                                                <div className="inline-block min-w-full py-2 align-middle ">
                                                      <table className="min-w-full overflow-x-auto ">
                                                            ...
                                                            <thead className="table-header-group  ">
                                                                  <tr className=" border border-gray-700 border-opacity-40 border-r-2 py-4  ">
                                                            ...
                                                            <tbody>
                                                                  {
                                                                        issue_data.map((issue) => (
                                                                              <tr key={issue?.issue_number} className="border border-gray-700 border-opacity-40">
                                                                                                      ...
                                                                                                      <div className="flex items-center justify-start  space-x-4  mx-auto">
                                                                                                            ...
                                                                                                            {issue.status !== 'rejected' ? <div className="flex items-center justify-start  space-x-4  mx-auto">
                                                                                                                  ...
                                                                                                                  <button
                                                                                                                        ...
                                                                                                                        onClick={() => delete_issue(issue._id)}
                                                                                                                        type="button"
                                                                                                                        className="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 transition-all duration-200 bg-gray-100 border border-gray-700 rounded-md shadow-sm hover:bg-red-400 focus:outline-none hover:text-white hover:border-red-400 focus:ring-2 focus:ring-offset-2  "
                                                                                                                  >
                                                                                                                        Delete Issue
                                                                                                                  </button>
                                                                                                            }
