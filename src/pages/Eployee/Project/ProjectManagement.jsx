...
const ProjectManagement = () => {
      ...
      const { data: project_data = [], refetch } = useQuery({
                                    ...
                                    <div class="overflow-hidden rounded-xl">
                                          <div class="py-6">
                                                <div class="sm:flex sm:items-start sm:justify-between">
                                                      <div>
                                                            ...
                                                            <p class="mt-1 text-sm font-medium text-gray-500">Here is all projects information</p>
                                                      </div>
                                          ...
                                          <div class="flow-root mt-8">
                                                <div class="-my-5 divide-y divide-gray-200">
                                                      {Array.isArray(project_data) && project_data?.map((project) => (
                                                            <div class="py-5">
