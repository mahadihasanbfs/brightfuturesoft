...
const BlogManagement = () => {
      ...
      const { data: blog_data = [], refetch, } = useQuery({
            queryKey: ["blog_data"],
            queryFn: async () => {
                                    ...
                                    <div class="overflow-hidden rounded-xl">
                                          <div class="py-6">
                                                <div class="sm:flex sm:items-start sm:justify-between">
                                                      <div>
                                                            <p class="text-lg font-bold text-gray-100">Blogs Management</p>
                                                            <p class="mt-1 text-sm font-medium text-gray-500">Here is all blogs information</p>
                                                      </div>
                                                                        ...
                                                                        <div class="flex items-center justify-between mt-4 sm:space-x-6 pl-14 sm:pl-0 sm:justify-end sm:mt-0">
                                                                              ...
                                                                              <div className=''>
                                                                                    <div className="flex gap-3 items-center  ">
                                                                                          ...
                                                                                          <button
                                                                                                type="button"
                                                                                                className="inline-flex whitespace-nowrap items-center justify-center px-6 py-3 text-sm font-semibold leading-5 text-white transition-all duration-200 bg-[#1c65b4] border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 hover:bg-indigo-500"
                                                                                          >
                                                                                                Edit
                                                                                          </button>
