            ...
            <div>
                  <section className="py-12  sm:py-16 lg:py-20 xl:py-24 ">
                        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                              ...
                              <form
                                    onSubmit={subscribe_news_letter}
                                    className="flex flex-col justify-between max-w-lg mx-auto mt-12 rounded-full sm:items-center sm:border sm:border-gray-700 sm:p-1 sm:flex-row sm:mt-16 sm:focus-within:border-blue-500 sm:focus-within:ring-1 sm:focus-within:ring-blue-500"
                              >
