...
const SignIn = () => {
      ...
      return (
            ...
            //                             required
            //                             type="email"
            //                             className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-700 text-black rounded shadow-sm appearance-none focus:border-purple-400 focus:outline-none focus:shadow-outline"
            //                             name="hello"
            //                         />
            //                     </div>
            //                     <div className="mb-1 sm:mb-2">
                                                ...
                                                <div className="relative flex items-center">
                                                      <div className="flex items-center h-5">
                                                            <input
                                                                  ...
                                                                  name="terms"
                                                                  id="terms"
                                                                  className="w-5 h-5  border-gray-700 rounded focus:ring-gray-900"
                                                            />
                                                      </div>
