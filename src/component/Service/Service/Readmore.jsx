                        ...
                        <div class="max-w-5xl px-4 mx-auto sm:px-6  mt-4 lg:px-8">
                              ...
                              <div className=" ">
                                    {selectedOffer.questions.map((question, idx) => (
                                          <div
                                                key={idx}
                                                className="transition-all mb-4 duration-200 border border-opacity-25 rounded border-gray-700 shadow-lg cursor-pointer"
                                          >
                                                <button
                                                      type="button"
...
const CallSchedule = ({ isModalOpen, setModalOpen }) => {
      ...
      return (
            <div className="fixed inset-0 z-50 flex items-center h-screen pt-20 justify-center backdrop-blur-xs">
